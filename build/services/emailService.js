...
var sendSimpleEmail = /*#__PURE__*/ (function () {
  var _ref = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(dataSend) {
          ...
          switch ((_context.prev = _context.next)) {
            case 0:
              ...
              return transporter.sendMail({
                from: '"PerryTheShark 👻" <tungtv.uet@gmail.com>',
                // sender address
                to: dataSend.receiverEmail,
                // list of receivers
                subject: "THONG TIN GUI EMAIL",
                // Subject line
                text: "Hello world?",
                // plain text body
  ...
  if (dataSend.language === "vi") {
    result = "\n    <h3> Xin chao "
      .concat(
        ...
        " </h3>\n    <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y b\u1EDFi v\xEC Bin th\xEDch th\u1EBF! </p>\n    <p>Thong tin dat lich test phong kham </p>\n    <div><b> Th\u1EDDi gian: "
      )
      .concat(dataSend.time, " </b> </div>\n    <div><b> B\xE1c s\u0129: ")
      .concat(
        dataSend.doctorName,
      ...
      .concat(
        ...
        ' target="_blank">Nh\u1EA5n v\xE0o \u0111\xE2y!</a>\n    </div>\n    <div> Thank you very much! </div>\n    '
      );
  }
...
var getBodyHTMLEmailRemedy = function getBodyHTMLEmailRemedy(dataSend) {
  ...
  if (dataSend.language === "vi") {
    result = "\n    <h3> Xin chao ".concat(
      dataSend.patientName,
      " </h3>\n    <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y b\u1EDFi v\xEC b\u1EA1n \u0111\xE3 \u0111\u1EB7t l\u1ECBch th\xE0nh c\xF4ng th\xEDch th\u1EBF! </p>\n    <p>Thong tin \u0111\u01A1n d\u01B0\u1EE3c g\u1EEDi trong file \u0111\xEDnh k\xE8m dat lich test phong kham </p>\n\n    <div> Thank you very much! </div>\n    "
    );
  }
  if (dataSend.language === "en") {
    result = "\n    <h3> Dear ".concat(
