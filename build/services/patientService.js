...
var buildUrlEmail = function buildUrlEmail(token, doctorId) {
  var result = ""
    .concat(process.env.URL_REACT, "/verify-booking?token=")
    .concat(token, "&doctorId=")
    .concat(doctorId);
  return result;
};
              ...
              while (1)
                switch ((_context2.prev = _context2.next)) {
                  ...
                  case 15:
                    resolve({
                      errCode: 2,
                      errMessage: "Appointment have been active or not valid!",
                    });
                  case 16:
                    _context2.next = 21;
                    break;
